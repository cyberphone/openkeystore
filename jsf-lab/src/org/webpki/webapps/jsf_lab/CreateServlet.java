...
public class CreateServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        StringBuilder js = new StringBuilder("'use strict';\n")
            .append(JSFService.keyDeclarations);
        StringBuilder html = new StringBuilder(
        ...
        js.append(
            ...
            "    fill('" + PRM_SECRET_KEY + "', alg, " + 
                 JSFService.KeyDeclaration.SECRET_KEYS + ", unconditionally);\n" +
            "    showSec(true)\n" +
            "  } else {\n" +
            "    showSec(false)\n" +
            ...
            JSFService.KeyDeclaration.PRIVATE_KEYS + ", unconditionally);\n" +
            "    showPriv(true);\n" +
            "    fill('" + PRM_CERT_PATH + "', alg, " + 
            JSFService.KeyDeclaration.CERTIFICATES + ", unconditionally);\n" +
